-- Accountability Class Record - Database Schema for Supabase/PostgreSQL
...
-- Insert default transmutation rules (DepEd standard)
-- These will be created automatically when a GradingScheme is created
